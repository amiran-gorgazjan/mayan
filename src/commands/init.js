...
program
    .description('Clone all repositories defined in .mayan.js and run npm i at the end.');
...
async function run() {
    ...
    info(green('Done! You can now run mayan check to compare the versions of the packages in the repositories.'));
}
